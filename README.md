...
-bin/wanna-smile_SILENT_RUNNER.py => wscript execution (update.vbs) & (ChromeUpdater.exe)
...
-bin/ARCHIVE_SFX/ChromeUpdater.lnk => shortcut to locate in Windows Startup Folder
-bin/ARCHIVE_SFX/update.vbs => vbs file for silent mode

-releases/wanna-smile.exe => wanna-smile.py compiled to EXE (single malware)
